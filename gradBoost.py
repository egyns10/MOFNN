...
def doGradBoost(data,true,gbParams):
    ...
    n_estimators = gbParams.get('n_estimators', 100)
    learning_rate = gbParams.get('learning_rate', 0.1)
    max_depth = gbParams.get('max_depth', 3)
    subsample = gbParams.get('subsample', 1.0)
